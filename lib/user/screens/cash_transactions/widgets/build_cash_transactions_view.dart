...
class BuildCashTransactionsView extends StatelessWidget {
  const BuildCashTransactionsView({Key? key, required this.model, required this.hasData, required this.data}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: GridView.builder(
        ...
        itemBuilder: (context, i) => BuildCashTransactionsItem(
          onTap: (){
            AutoRouter.of(context).push(AddTransactionRoute(model: model[i],transactionName: "المعاملات النقدية"));
          },
