...
class MyExpansionTile extends StatelessWidget {
  ...
  GlobalKey<FormState> keyFrorm = GlobalKey();
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        BuildNamesExpansion(
          namesFormKey: keyFrorm,
          designationController: firstController,
          firstNameController: secondController,
          lastNameController: thirdController,
        ),
        // const SizedBox(height: 16.0),
        // BuildPhoneExpansion(
